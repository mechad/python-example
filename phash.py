...
if __name__ == '__main__':
    ...
    # 创建命令行参数解析器
    parser = argparse.ArgumentParser(description='phash ahash dhash 三种图像相似度检测对比')
    parser.add_argument('image1', type=str, help='image1')
    parser.add_argument('image2', type=str, help='image2')
